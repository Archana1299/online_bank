...
<body>
    ...
    <div class="tagline-lower text-center text-expanded text-shadow text-uppercase text-white mb-5 d-none d-lg-block"> A GOVERNMENT OF INDIA UNDERTAKEN</div>
							...
							<a class="nav-link text-uppercase text-expanded" href="bankhomepage.html">Home
						</a>
						</li>
						<li class="nav-item px-lg-4">
    ...
    <main class="container">
      <div class="container">
        <div class="bg-faded p-4 my-4">
          <hr class="divider">
<h2 class="text-center text-lg text-uppercase my-0">Customer Status</strong>
          </h2>
<hr class="divider">
...
<td><?php echo $row['last updated']; ?></td>
